...
int main(void){
  ...
  readfile("1 alpha.txt", x0,  col, N);
  readfile("2 beta.txt", x1,  col, N);
  readfile("3 gamma.txt", x2,  col, N);
  readfile("4 delta.txt", x3,  col, N);
  readfile("5 epsilon.txt", x4, col, N);
  readfile("6 dseta.txt", x5,  col, N);
  readfile("7 eta.txt", x6,  col, N);
  readfile("8 theta.txt", x7,  col, N);
  readfile("9 iota.txt", x8,  col, N);
  readfile("10 kappa.txt", x9,  col, N);
  readfile("11 lambda.txt", x10,  col, N);
  readfile("12 mi.txt", x11,  col, N);
  readfile("13 ni.txt", x12,  col, N);
  readfile("14 xi.txt", x13,  col, N);
  readfile("15 omicron.txt", x14, col, N);
  readfile("16 pi.txt", x15,  col, N);
  readfile("17 rho.txt", x16,  col, N);
  readfile("18 sigma.txt", x17,  col, N);
  readfile("19 tau.txt", x18,  col, N);
  readfile("20 ipsilon.txt", x19,  col, N);
  readfile("21 fi.txt", x20,  col, N);
  readfile("22 ji.txt", x21,  col, N);
  readfile("23 psi.txt", x22,  col, N);
  readfile("24 omega.txt", x23,  col, N);
